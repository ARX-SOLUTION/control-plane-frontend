...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'inline-flex items-center justify-start rounded-md bg-bg-2 p-1 text-fg-muted',
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={cn(
      ...
      'data-[state=active]:bg-bg-1 data-[state=active]:text-fg data-[state=active]:shadow-sm',
      className
    )}
    {...props}
  />
